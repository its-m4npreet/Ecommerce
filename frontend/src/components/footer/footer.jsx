        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-5 gap-10">
            ...
            <div className="md:col-span-2 flex flex-col gap-4">
                <div className="flex items-center gap-2 mb-2">
                    <FaOpencart  className="text-2xl text-blue-500" />
                    <span className="text-2xl font-bold tracking-tight text-white">E-Shop</span>
                </div>
                <p className="text-gray-400 text-sm">
                    Your one-stop shop for the latest products and best deals. Shop with confidence and enjoy fast delivery!
                </p>
                <div className="flex gap-2 mt-2">
                    <a href="#" className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-3 py-2 rounded text-xs font-semibold transition">
