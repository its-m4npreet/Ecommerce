...
return <div className="links flex gap-3">
                    ...
                    <NavLink to="/trolley" className="flex items-center gap-2 px-4 py-2 rounded font-medium text-white hover:text-cyan-400 transition-colors duration-200">
                        <FaShoppingCart />
                        Trolley
                    </NavLink>
                </div>
...
const Logo=()=>{
    return <div className="w-14 h-14 flex items-center">
                <FaOpencart className="w-full h-full object-contain text-blue-500" />
            </div>
}
